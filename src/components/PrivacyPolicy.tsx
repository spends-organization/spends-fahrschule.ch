    ...
    <Layout>
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-4">
            Unsere Website wird auf unserem eigenem Servern gehostet. Diese bieten eine schnelle und zuverlässige Bereitstellung unserer Inhalte.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">Änderungen</h2>
          <p>Wir behalten uns vor, diese Datenschutzerklärung jederzeit anzupassen. Die jeweils aktuelle Version finden Sie auf unserer Website.</p>
        </div>
      </div>
    </Layout>
  );
