...
const Advantages: React.FC = () => {
  const advantages = [
    ...
    },
    {
      ...
      description: "Unsere Fahrlehrer in Winterthur, Effretikon, Bassersdorf und Frauenfeld sind nicht nur qualifiziert, sondern auch geduldig und unterstützend."
    },
    {
    ...
    <section id="vorteile" className="section-padding bg-gray-50">
      <div className="container mx-auto">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Warum Spend's Fahrschule?</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Wir bieten dir eine erstklassige Fahrausbildung in Winterthur, Effretikon, Bassersdorf und Frauenfeld mit einer persönlichen Note und dem Ziel, dich zu einem sicheren und selbstbewussten Fahrer zu machen. Ausserdem bieten wir auch den VKU an in unserem Standort in Winterthur.
          </p>
        </AnimatedSection>
